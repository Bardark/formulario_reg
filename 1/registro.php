		...
		<div class="col-md-6">
			...
			<form role="form" name="registro" action="php/registro.php" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <input type="date" class="form-control" id="datepicker_i" name="datepicker_i" placeholder="Fecha de inicio">
			  </div>
			  <div class="form-group">
			    <label for="datepicker_t">Fecha de termino:</label>
			    <input type="email" class="form-control" id="datepicker_t" name="datepicker_i" placeholder="Fecha de termino">
			  </div>
			  <div class="form-group">
